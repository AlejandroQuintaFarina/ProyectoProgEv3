...
public class Conectar {
    ...
    public static Boolean validarLogin (String user, String password) throws SQLException{
     ...
     public static void ActualizarDatos(JTable tabla){
        Conectar conect = new Conectar();
        Connection conexion= conect.Conecta();
         ...
         String apel = tabla.getValueAt(fila, 1).toString();
         String dni = tabla.getValueAt(fila, 2).toString();
         String telf = tabla.getValueAt(fila, 3).toString();
         String mail = tabla.getValueAt(fila, 4).toString();
         String fechaent = tabla.getValueAt(fila, 5).toString();
         int dias = Integer.parseInt(tabla.getValueAt(fila, 6).toString());
         try{
     ...
     public static void EliminarCliente(JTable tabla){
        ...
        Connection conexion= conect.Conecta();
         ...
         try{
            ...
            antiguo.setString(1,tabla.getValueAt(fila, 0).toString());
            antiguo.setString(2,tabla.getValueAt(fila, 1).toString());
            antiguo.setString(3,tabla.getValueAt(fila, 2).toString());
            antiguo.setString(4,tabla.getValueAt(fila, 3).toString());
            antiguo.setString(5,tabla.getValueAt(fila, 4).toString());
            antiguo.setString(6,tabla.getValueAt(fila, 5).toString());
            antiguo.setString(7,tabla.getValueAt(fila, 6).toString());
